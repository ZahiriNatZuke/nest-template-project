...
export const UpdatePasswordSchema = z.object({
	...
	confirm_new_password: z
		...
		.atLeastOne(
			'lowercase',
			'Confirmation New Password must contain at least one lowercase letter'
		)
		.atLeastOne(
			'uppercase',
			'Confirmation New Password must contain at least one uppercase letter'
		)
		.atLeastOne(
			'digit',
			'Confirmation New Password must contain at least one number'
		)
		.atLeastOne(
			'special',
			'Confirmation New Password must contain at least one special character'
		),
});
