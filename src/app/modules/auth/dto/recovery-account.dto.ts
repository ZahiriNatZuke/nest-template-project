...
export const RecoveryAccountSchema = z.object({
  ...
  confirmNewPassword: z.password()
    ...
    .atLeastOne('lowercase', 'Confirm New Password must contain at least one lowercase letter')
    .atLeastOne('uppercase', 'Confirm New Password must contain at least one uppercase letter')
    .atLeastOne('digit', 'Confirm New Password must contain at least one number')
    .atLeastOne('special', 'Confirm New Password must contain at least one special character'),
});

export class RecoveryAccountZodDto extends createZodDto(RecoveryAccountSchema) {
}
